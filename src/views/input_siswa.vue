        ...
        <div class="py-8 px-10 w-10/12">
            ...
            <div class="mt-12 p-4 space-y-4 text-sm bg-slate-200 rounded-md">
                <div>
                    ...
                    <input type="text" v-model="nama" class="mt-2 form-control" placeholder="Masukan Nama siswa">
                </div>
                <div>
                    <label for="kelas">Kelas</label>
                    <select v-model="kelas" class="mt-2 form-control">
                ...
                <div>
                    ...
                    <select v-model="jurusan" class="mt-2 form-control">
                ...
                <div>
                    ...
                    <textarea v-model="alamat" class="mt-2 form-control" placeholder="Masukan Nama siswa"></textarea>
                </div>
                <div>
                    <label for="nohp">No HP</label>
                    <input type="text" v-model="nohp" class="mt-2 form-control" placeholder="Masukan Nama siswa">
                    <input type="hidden" v-model="userId" class="w-full">
                </div>
                <button @click.prevent="addorupdateuser" class="btn-slate">{{ type }} Data</button>
            </div>
                        ...
                        <tbody class="bg-white font-medium">
                            <tr :class="i%2==0 ? 'bg-white' : 'bg-gray-100'" v-for="(data, i) in allUser.data" :key="data._id">
                                ...
                                <th class="px-4 py-3 border text-md">
                                    <a href="#" @click="inputPelanggaran(data._id)" class="text-blue-500">Entri</a>
                                </th>
                                <th class="px-4 py-3 border text-md">
                                    <a href="#" @click="detailPelanggaran(data._id)" class="text-blue-500">Lihat</a>
                                </th>
                                <th class="px-4 py-3 border text-md">
                                    <a href="#" @click="editSiswa(data._id)" class="text-blue-500">Edit</a> | 
                                    <a href="#" @click="deleteSiswa(data._id)" class="text-blue-500">Hapus</a>
                                </th>
                            </tr>
                        </tbody>
                    </table>
